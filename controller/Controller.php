...
class Controller
{
    ...
    public function checkAction()
    {
        ...
        /*READ:  overzicht alle patienten , als er niet is ingelogd dan inlogformulier*/
        else {
